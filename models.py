...
class Member(UserMixin, db.Model):
    ...
    role = db.Column(db.String(30), nullable=False, default="member")  # member/team_lead/project_manager/admin
...
class PrintJob(db.Model):
    ...
    status = db.Column(db.String(20), nullable=False, default="pending")  # pending/queued/printing/done/failed
